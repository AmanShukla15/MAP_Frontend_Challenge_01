import cardsData from "../assets/sampleData/data.js";
import imageData from "../assets/images/564931.jpg"
            ...
            {cardsData.map((card, index) => (
                ...
                >
                    <div className="w-full h-full relative">
                        ...
                        <div
                            className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-black to-transparent rounded-b-md"
                        >
                            <div className="absolute inset-0 flex flex-col items-center text-white text-xs top-8 gap-3">
                                ...
                                <div className=" w-full pl-3 flex-1 font-semibold">
                                    <div className="flex justify-between h-1/2">
                                        <div>
                                            <FontAwesomeIcon icon={faClock} className="text-[#74C0FC] mr-2" />2N/30
                                        </div>
                                        <div className="pr-3">
                                            <FontAwesomeIcon icon={faMapMarkerAlt} className="text-[#74C0FC] mr-2" />Delhi
                                        </div>
                                    </div>

                                    <div>
                                        <FontAwesomeIcon icon={faCalendar} className="text-[#74C0FC] mr-2" />30 May
                                    </div>
                                </div>
                            </div>
                        </div>
